...
function customTabs() {
    $('.ameneties_titles li').each(function(index){
        var count = index + 1;
        $(this).find('a').click(function(e){
            e.preventDefault();
            $('.sc_widget_slider').removeClass('active');
            $('.sc_slider'+ count).addClass('active');
            $('.ameneties_titles li').removeClass('ui-tabs-active ui-state-active');
